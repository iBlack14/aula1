...
<div class="swiper-slide lg:odd:mb-7 lg:even:mt-7 swiper-slide-prev">
    <div
        class="relative flex-center aspect-[1/1.33] overflow-hidden custom-transition group/instructor before:absolute before:size-full before:inset-0 before:bg-overlay-gradient before:opacity-0 hover:before:opacity-100 before:custom-transition">
        <!-- THUMBNAIL -->
        <img data-src="{{ $thumbnail }}" alt="Instructor image"
            class="size-full object-cover group-hover/course:scale-110 custom-transition">
        <!-- CONTENT -->
        <div
            class="absolute right-0 bottom-0 left-0 p-7 pt-10 bg-overlay-gradient overflow-hidden shrink-0 custom-transition">
