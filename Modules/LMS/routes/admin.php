    ...
    function () {
        ...
        Route::prefix('course')->group(
            function () {
                ...
                Route::put('bundle/restore/{id}', [BundleController::class, 'restore'])->name('bundle.restore');
                Route::get('bundle/{id}/translate/{locale}', [BundleController::class, 'edit'])->name('bundle.translate');
            }
        );
        ...
        /** contact **/
        Route::group(
            ['prefix' => 'contact', 'as' => 'contact.', 'controller' => ContactController::class],
            function () {
        ...
        /**  Theme Option **/
        Route::group(
            ['prefix' => 'theme-setting', 'controller' => ThemeSettingController::class],
            function () {
        ...
        /**  support **/
        Route::group(
            ['prefix' => 'support-ticket', 'as' => 'support-ticket.'],
            function () {
