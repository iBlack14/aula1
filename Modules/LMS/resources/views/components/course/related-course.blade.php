        ...
        <div class="grid grid-cols-12 gap-4 items-center">
            ...
            <div class="col-span-full md:col-span-5 xl:col-span-6 md:justify-self-end">
                <div class="flex items-center gap-2">
                    <button type="button" class="pagination related-courses-prev" aria-label="Course slider previous button">
                        <i class="ri-arrow-left-line rtl:before:content-['\ea6c']"></i>
                    </button>
                    <button type="button" class="pagination related-courses-next" aria-label="Course slider next button">
