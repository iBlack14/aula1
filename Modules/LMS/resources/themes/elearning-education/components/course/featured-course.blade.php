        ...
        <div class="grid grid-cols-12 gap-4 items-center">
            ...
            <div class="col-span-full md:col-span-5 xl:col-span-6 md:justify-self-end">
                <div class="flex items-center gap-2">
                    <button type="button" aria-label="Course slider previous" class="pagination style-two featured-courses-prev">
                        <i class="ri-arrow-left-line rtl:before:content-['\ea6c']"></i>
                    </button>
                    <button type="button" aria-label="Course slider next" class="pagination style-two featured-courses-next">
